<template>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        <h5 class="my-0 mr-md-auto font-weight-normal">com&middot;<span style="color: #9e1b45;">be</span>&middot;nations Sprachtraining</h5>
        <nav class="my-2 my-md-0 mr-md-3">
            <router-link class="p-2 text-dark" :to="{ name: 'scheduleTraining' }" v-if="userType === 'attendee'">
                Neues Sprachtraining
            </router-link>
            <router-link class="p-2 text-dark" :to="{ name: 'trainingsList' }">Trainings</router-link>
            <router-link class="p-2 text-dark" :to="{ name: 'calendar' }">Kalender</router-link>
